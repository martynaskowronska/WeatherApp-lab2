...
namespace WeatherApp.Controller
{
    ...
    // Kontroler "przejął" to co wcześniej było robione w widoku i jest teraz łącznikiem między
    // widokiem a modelem
    internal class WeatherAppController
    {
        City selectedCity;
        AccuWeatherService accuWeatherService;
        public WeatherAppController(City selectedCity, AccuWeatherService accuWeatherService)
        {
